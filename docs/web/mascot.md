...
```{image} ../../etc/img/sachi/electrichearts_20211013A_sachi_trans.png
``` 
...
```{image} ../../etc/img/sachi/electrichearts_20220323A_sachi.png
``` 

```{image} ../../etc/img/sachi/electrichearts_20220325A_sachi_yellow.png
``` 

Full-resolution images with and without transparent backgrounds can be downloaded from the [GitHub Repository](https://github.com/lethalbit/squishy/tree/main/) in the [`etc/img/sachi`](https://github.com/lethalbit/squishy/tree/main/etc/img/sachi) directory.
